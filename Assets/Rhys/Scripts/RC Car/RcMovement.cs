...
public class RcMovement : MonoBehaviour
{
    ...
    {
        // when the RC Car is turned on, make sure it is not kinematic
    ...
    {
        // when the RC Car is turned off, set it to kinematic so it stops moving
    ...
    private void Move()
    {
        // create a vector in the direction the RC Car is facing with a magnitude
